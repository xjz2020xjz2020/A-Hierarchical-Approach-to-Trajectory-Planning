...
ref_x = []; ref_y = [];
for ii = -10 : 220
    [xr, yr, lb, rb, ref_theta] = ProvideReferenceLineInfoEdge(ii);
...
plot(road_left_barrier_x, road_left_barrier_y, 'k');
plot(road_right_barrier_x, road_right_barrier_y, 'k');
plot(ref_x, ref_y, 'k.');
